...
פתרון למשימת בית, אוטומציה שסורקת את הנכסים הדיגיטליים של לקוח חדש, שולפת ממנו מידע, ומייצרת כרטיס לקוח, תסריט שיחה, ורישום CRM.
...
6. **דף תוצאות** — עמוד שנפתח אוטומטית בדפדפן בסוף הריצה
...
- **מכסת טוקנים** — בגרסה החינמית של Groq מגבילים 100,000 טוקנים ליום. אם נגמרה המכסה, ממתינים עד למחרת
- **דפי זהב** — האתר חוסם סורקים אוטומטיים. מצב ההדגמה משתמש בנתונים מדומים ריאליסטיים
- **שליחת מייל** — כרגע מסומלצת ונשמרת לקובץ. ראו הוראות לחיבור אמיתי בקובץ crm.py
